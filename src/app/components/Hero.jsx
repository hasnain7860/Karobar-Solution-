...
// WhatsApp Logo Component for clear branding
const WhatsAppIcon = () => (
  ...
  return (
    <section className="pt-28 pb-16 lg:pt-36 lg:pb-24 bg-gradient-to-b from-indigo-50 via-white to-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        {/* Primary CTA - Now Redirects to WhatsApp */}
        <div className="flex flex-col sm:flex-row justify-center gap-4 mb-16">
          ...
          {/* <button className="px-8 py-4 text-lg font-bold rounded-xl text-indigo-700 bg-indigo-50 border-2 border-indigo-100 hover:bg-indigo-100 transition-all">
            Video Dekhein
          </button> 
          */}
        </div>
        ...
        <div className="relative mx-auto w-[280px] sm:w-[320px]">
          <div className="relative rounded-[2.5rem] bg-slate-900 p-3 shadow-2xl border-4 border-slate-800 ring-1 ring-slate-900/10">
            <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-1/3 h-6 bg-slate-900 rounded-b-xl z-10"></div>
            
            <div className="relative rounded-[2rem] overflow-hidden bg-slate-100 aspect-[9/19] flex items-center justify-center">
              <div className="relative w-full h-full">
                 <Image 
                    src="/images/dashboard.png" 
                    alt="Karobar Solution Dashboard Mobile View"
                    fill
